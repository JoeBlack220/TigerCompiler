...
module Printabsyn : PRINTABSYN = struct
  module A = Absyn
  ...
  and ty = function
    | A.NameTy(s,p), d -> 
       indent d; say "NameTy("; say(Symbol.name s);
       say ")"
    ...
    | A.ArrayTy(s,p), d ->
       indent d; say "ArrayTy("; say(Symbol.name s);
       say ")"
