...
%token <Analysis.Ab.pos> FOR WHILE BREAK LET IN NIL TO END
%token <Analysis.Ab.pos> FUNCTION VAR TYPE ARRAY IF THEN ELSE DO OF
%token <Analysis.Ab.pos> LPAREN RPAREN LBRACK RBRACK LBRACE RBRACE
%token <Analysis.Ab.pos> DOT COLON COMMA SEMICOLON
%token <Analysis.Ab.pos> PLUS MINUS TIMES DIVIDE
%token <Analysis.Ab.pos> EQ NEQ LT LE GT GE
%token <Analysis.Ab.pos> AND OR
